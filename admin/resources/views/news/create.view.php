...
<div class="users card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary"><?= $lang_news_create_title?></h6>
  </div>
  <div class="card-body">
    <div class="row">
      <div class="col-md-9">
          ...
          <form method="POST" enctype="multipart/form-data">
            ...
            <div class="form-row">
              <div class=" username-field form-group col-md-12">
                ...
                <input type="text" name="short_desc" class="form-control" id="inputTitle" value="<?= $this->showValue('short_desc')?>">
              </div>
            </div>
            <div class="form-group">
              <label for="Textarea1"><?= $lang_labels_content?></label>
              <textarea name="content" class="form-control" id="newsEditor" rows="15">
              <?= $this->showValue('content')?></textarea>
            </div>
