...
<div class="home">
  <div class="warpper">
    <div class="home-content">
      <div id="demo1">
        <div class="slide">
          <img src="/assets/img/doc_slide2.jpg" />
          <div class="container">
            <!--Slider Description-->
            <div class="slide-desc">
              <h2><?= $lang_home_home_title?></h2>
              <span><?= $lang_home_home_desc?></span>
              <p><?= $lang_home_home_short_desc?></p>
            </div>
          </div>
        </div>
        <div class="slide">
          <img src="/assets/img/lady2.jpg" />
          <!--Slider Description-->
          <div class="container">
            <div class="slide-desc">
              <h2><?= $lang_home_home_2_title?></h2>
              <img class="info-img" src="/assets/img/oppning_time.png" alt="">
            </div>
          </div>
        </div>
        <div class="slide">
          <img src="/assets/img/lady3.jpg" />
          <!--Slider Description-->
          <div class="container">
            <div class="slide-desc">
    ...
    <div class="row text-center">
      <div class="col-xs-12 col-sm-4">
        <div class="box-content">
          <div class="img-content" data-aos="flip-left" data-aos-duration="1000" data-aos-delay="100">
            <img src="/assets/img/dep/dep-2.png" class="img-responsive" alt="">
          </div>
          <h3><?= $lang_home_top_one?></h3>
        </div>
      </div>
      <div class="col-xs-12 col-sm-4">
        <div class="box-content">
            <div class="img-content" data-aos="flip-up" data-aos-duration="1000" data-aos-delay="100">
              <img src="/assets/img/dep/dep-8.png" class="img-responsive" alt="">
            </div>
            <h3><?= $lang_home_top_tow?></h3>
        </div>
      </div>
      <div class="col-xs-12 col-sm-4">
        <div class="box-content">
          <div class="img-content" data-aos="flip-right" data-aos-duration="1000" data-aos-delay="100">
            <img src="/assets/img/dep/dep-5.png" class="img-responsive" alt="">
          </div>
          <h3><?= $lang_home_top_three?></h3>
        </div>
      </div>
    </div>
    <div class="row tow">
        ...
        <div class="box-content">
          <div class="row">
            <div class="col-xs-12 col-md-6 left">
              <h3>Blutabnahmen</h3>
              <p>Für die Blutabnahme stehen wir Ihnen die Zeiten von Montag bis Freitag 08:00 bis 10:30 Uhr zur Verfügung. Bitte vereinbaren Sie vorher einen Termin. Nüchtern bedeutet 12 Std. vor der Blutentnahme:</p>
              <span>nicht essen</span>
              <span>nicht rauchen</span>
              <span>keine kalorienhaltigen Getränke zu sich zu nehmen</span>
              <span>Trinken von Mineralwasser oder ungesüßtem Tee ist erlaubt!</span>
    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="header-title text-center">
          <h2><?= $lang_home_sec_services?></h2>
          <p><?= $lang_home_sec_services_sub?></p>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="content">
        <div class="col-xs-12 col-md-4 left">
          <a href="/<?php if(isset($_SESSION['lang_changed'])){echo $_SESSION['lang'] . '/';}?>services/page/id/1">
            <div class="col-xs-12 box-content" data-aos="zoom-in" data-aos-duration="500"  data-aos-delay="100">
                <div class="label-icon">
                  <span>
                    <img src="/assets/img/service/service-1.png" class="img-responsive" alt="">
                  </span>
                </div>
                <div class="label-content">
                  <h6>Praxis-Leistungen</h6>
                  <p>Als hausärztlicher tätiger Internist bieten wir Ihnen ein breites Spektrum an präventiven...</p>
                </div>
            </div>
          </a>
          <a href="/<?php if(isset($_SESSION['lang_changed'])){echo $_SESSION['lang'] . '/';}?>services/page/id/2">
            <div class="col-xs-12 box-content" data-aos="zoom-in" data-aos-duration="600"  data-aos-delay="150">
                <div class="label-icon">
                  <span>
                    <img src="/assets/img/service/service-1.png" class="img-responsive" alt="">
                  </span>
                ...
                <div class="label-content">
                  <h6>Der Knöchel-Arm-Index</h6>
                  <p>handelt es sich um eine Untersuchungsmethode, die das Risiko für...</p>
                </div>
            </div>
          </a>
          <a href="/<?php if(isset($_SESSION['lang_changed'])){echo $_SESSION['lang'] . '/';}?>services/page/id/3">
            <div class="col-xs-12 box-content" data-aos="zoom-in" data-aos-duration="700"  data-aos-delay="200">
              <div class="label-icon">
                <span>
                  <img src="/assets/img/service/service-1.png" class="img-responsive" alt="">
                </span>
              ...
              <div class="label-content">
                <h6>Individuelle Gesundheitsleistungen</h6>
                <p>Viele wirksame medizinische Behandlungen sind für die ...</p>
              </div>
            </div>
          </a>

        </div>
        <div class="col-xs-12 col-md-4 center text-center" data-aos="fade-up" data-aos-duration="1500"  data-aos-delay="100" >
          <img src="/assets/img/service.png" class="img-responsive" alt="">
        </div>
        <div class="col-xs-12 col-md-4 right">
          <a href="/<?php if(isset($_SESSION['lang_changed'])){echo $_SESSION['lang'] . '/';}?>services/page/id/4">
            <div class="col-xs-12 box-content" data-aos="zoom-in" data-aos-duration="600"  data-aos-delay="150">
                <div class="label-icon">
                  <span>
                    <img src="/assets/img/service/service-1.png" class="img-responsive" alt="">
                ...
                <div class="label-content">
                  <h6>Beschneidung</h6>
                  <p>Mit Alisklamp Methode und nach Wunsch ..Mit Alisklamp Methode und nach Wunsch</p>
                </div>
            </div>
          </a>
          <a href="/<?php if(isset($_SESSION['lang_changed'])){echo $_SESSION['lang'] . '/';}?>services/page/id/5">
            <div class="col-xs-12 box-content" data-aos="zoom-in" data-aos-duration="700"  data-aos-delay="200">
              <div class="label-icon">
                <span>
                  <img src="/assets/img/service/service-1.png" class="img-responsive" alt="">
              ...
              <div class="label-content">
                <h6>Schröpfen</h6>
                <p>Die Behandlung erfolgt durch Saugen und Auslaufen von Blut mithilfe von Bechern...</p>
              </div>
            </div>
          </a>
          <a href="/<?php if(isset($_SESSION['lang_changed'])){echo $_SESSION['lang'] . '/';}?>services/page/id/6">
            <div class="col-xs-12 box-content" data-aos="zoom-in" data-aos-duration="800"  data-aos-delay="250">
              <div class="label-icon">
                <span>
                  <img src="/assets/img/service/service-1.png" class="img-responsive" alt="">
                </span>
              ...
              <div class="label-content">
                <h6>Diagnostik in der Praxis</h6>
                <p>Wir bieten umfangreiches Diagnostik in der Praxis wie....</p>
              </div>
            </div>
          </a>
        </div>
            ...
            <div class="col-xs-12 col-md-6">
              <div class="box one">
                <div class="content">
                  <h3><?= $new->Title?></h3>
                  <p><?= $new->Short_desc?></p>
                  <a href="/<?php if(isset($_SESSION['lang_changed'])){echo $_SESSION['lang'] . '/';}?>news/details/id/<?=$new->NewsId?>"><?=$lang_home_sec_new_btn?></a>
                </div>
              </div>
            </div>
...
<div class="team">
  <div class="container">
    <div class="row">
      <div class="col-xs-12">
        <div class="header-title text-center">
          <h2><?= $lang_home_sec_team?></h2>
          <p><?= $lang_home_sec_team_sub?></p>
      ...
      <div class="content">
        <div class="row">
          <?php if(false !== $users): foreach ($users as $user): ?>
            <a href="/<?php if(isset($_SESSION['lang_changed'])){echo $_SESSION['lang'] . '/';}?>team/doctor/id/<?=$user->UserId?>">
              <div class="col-xs-6 col-sm-6 col-md-3" data-aos="fade-up" data-aos-duration="1500">
                <div class="card">
                  <div class="top">
                  </div>
                  <div class="center">
                      <img src="/uploads/images/users/<?=$user->Image?>" alt="img-responsive">
                  </div>
                  <div class="bottom">
...
<div class="blog">
  <div class="container">
    <div class="row">
      <div class="col-xs-12">
        <div class="header-title text-center">
          <h2><?= $lang_home_sec_blog?></h2>
          <p><?= $lang_home_sec_blog_sub?></p>
        </div>
      </div>
    </div>
    <div class="wrapper">
      <div class="content">
        ...
        <div id="owl-demo" class="owl-carousel owl-theme">
          <?php if(false !== $blogs): foreach ($blogs as $blog): ?>
            <a href="/<?php if(isset($_SESSION['lang_changed'])){echo $_SESSION['lang'] . '/';}?>blog/show/id/<?=$blog->BlogId?>" style="text-decoration:none;">
              <div class="item">
